...
---Question 2 
CREATE PROCEDURE Customer_By_Name 
AS  
BEGIN 
SELECT * FROM Customers 
WHERE contactName = 'Shabalin, Rostislav' 
END; 
EXEC Customer_By_Name; 

---Question 3 
CREATE PROCEDURE Get_Customer_Orders(@customerID INT) 
AS  
BEGIN 
SELECT * FROM Orders 
WHERE CustomerID = 89 
END; 
EXEC Get_Customer_Orders '89'; 
---Question 4 
CREATE PROCEDURE Bottom5Products 
AS  
BEGIN 
SELECT TOP 5 Products.ProductName,count(OrderDetails.productId) AS orderCount 
FROM Products 
JOIN OrderDetails ON Products.ProductID = OrderDetails.productId 
GROUP BY Products.ProductName,OrderDetails.productId 
ORDER BY orderCount ASC; 
END; 
EXEC Bottom5Products;

---Question 5 
CREATE VIEW [London Customers] 
AS  
SELECT contactName,city 
FROM Customers 
WHERE city = 'London'; 
SELECT * FROM [London Customers]; 
...
---Question 8 
CREATE VIEW EmployeeTerritoryView 
AS  
SELECT Employees.employeeId,CONCAT( Employees.firstname,' ',Employees.lastname) AS 
Employeename,Territories.territorydescription 
FROM Employees 
JOIN EmployeeTerritories  ON Employees.employeeId = EmployeeTerritories.employeeId 
JOIN Territories ON EmployeeTerritories.territoryId = Territories.territoryId; 
SELECT * FROM EmployeeTerritoryView; 