...
--Question_6 
SELECT DISTINCT firstName + ', ' + lastName AS [Names from same city] 
FROM Employees 
...
--Question_7 
SELECT orderId,'Shipped' AS Status 
FROM Orders 
WHERE shippedDate IS NOT NULL 
UNION ALL 
SELECT orderId,'Pending' AS Status 
FROM Orders 
WHERE shippedDate IS NULL; 

--Question_8 
SELECT COUNT(address) AS [Address count],'Customers' AS Category 
FROM Customers 
UNION ALL 
SELECT COUNT(address) AS [Address count],'Suppliers' AS Category 
FROM Suppliers; 