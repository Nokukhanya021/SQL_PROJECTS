...
ORDER BY TotalOrders DESC,employeeId
...
---QUESTION 4
SELECT  CONCAT(LEFT (firstname,2),RIGHT(lastname,3),'@',country,postalCode) AS 'PASSWORD'
FROM Employees;

---QUESTION 5
SELECT TOP 5 Customers.CustomerID,Customers.companyName, COUNT (Orders.orderId) AS  TotalOrders
FROM Customers
JOIN Orders ON Customers.CustomerID =Orders.CustomerID
WHERE YEAR(Orders.orderDate) ='2007'
